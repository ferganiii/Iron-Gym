...
export default function ExerciseDetails() {
  ...
  const [exercise, setExercise] = useState(null); // استخدام null بدلاً من مصفوفة فارغة
  ...
  async function fetchExercise() {
    try {
      ...
      // تحقق من أن البيانات هي كائن وليس مصفوفة
      if (res.data.docs) {
        setExercise(res.data.docs);
      } else {
        setExercise(res.data); // في حالة كانت الـ API تعيد كائن واحد بدلاً من مصفوفة
      }
    } catch (err) {

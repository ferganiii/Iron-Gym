      ...
      <>
        <div className="relative w-full h-screen bg-black overflow-hidden">
          <img
            src={bacKGROUND}
            alt="Background"
            className={`absolute inset-0 w-full h-full object-cover object-center transition-all duration-500 ${showForm ? "blur-md" : "blur-0"
              }`}
          />

          <div
            className={`absolute inset-0 bg-black transition-all duration-500 ${showForm ? "opacity-70" : "opacity-60"
              }`}
          ></div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      {formik.errors.name && formik.touched.name && (
                        <div className="p-4 mb-4 text-sm text-orange-800 rounded-lg bg-red-500 dark:text-red-600">

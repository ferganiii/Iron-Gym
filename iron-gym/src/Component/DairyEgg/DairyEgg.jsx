...
export default function DairyEgg() {
  const [data] = useState(nutritionData.dairyEgg || []);
  ...
  return (
    <section className="relative bg-[rgb(102,102,102,.3)]">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${milk})` }}
      >
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="pb-10">
          <h2 className="text-4xl font-archivo">
            The richest sources of dairy and egg products <br /> and the
            average values and nutrients per 100g
          </h2>
        </div>
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-3xl max-sm:text-xl text-gray-700 uppercase bg-gray-50 dark:bg-[rgb(102,102,102,.3)] dark:text-orange-500">
              <tr>
                ...
                <th scope="col" className="px-6 py-5">Fats</th>
              </tr>
            </thead>

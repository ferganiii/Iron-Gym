        ...
        <div className="relative w-full h-screen bg-black overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-10 sm:bottom-24 flex flex-col items-center text-center text-white px-4 pb-10 sm:pb-28 z-20">
            ...
            <button 
              ...
              className="mt-6 sm:mt-10 bg-orange-500 hover:bg-orange-600 text-white px-8 sm:px-12 py-3 sm:py-4 rounded-lg text-xl sm:text-2xl md:text-3xl font-semibold transition-colors duration-300 transform hover:scale-105"
            >
              Register
            </button>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center relative">
              ...
              <div className="space-y-6 md:space-y-8 z-10 text-center md:text-left">
                ...
                <button 
                  ...
                  className="border text-xl md:text-2xl border-orange-600 px-6 md:px-8 py-2 rounded-2xl hover:bg-orange-500 transition-colors duration-300"
                >
                  EXPLORE EXERCISES
                </button>
              </div>
